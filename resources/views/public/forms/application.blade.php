...
<head>
    ...
    <title>Apply for Aid - YB Dato' Zunita Begum</title>
...
<body>
    ...
    <main class="main">
        <div class="form-container">
            <h1 class="form-title">Apply for Financial Assistance</h1>
            <p class="form-description">
                Apply for financial aid for education, medical expenses, or emergency situations. All applications are reviewed confidentially.
            </p>

            <form method="POST" action="{{ route('public.forms.application.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea name="purpose" class="form-textarea" placeholder="Please describe how you plan to use this assistance..." required></textarea>
                    @error('purpose') <div class="error-message">{{ $message }}</div> @enderror
                </div>

                <div class="form-group">
                    <label class="form-label">Current Situation</label>
                    <textarea name="current_situation" class="form-textarea" placeholder="Describe your current financial situation and why you need assistance..." required></textarea>
                    @error('current_situation') <div class="error-message">{{ $message }}</div> @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload">
                        ...
                        <p class="form-help">Please include: IC, proof of income, relevant bills/receipts (Max 5MB each)</p>
                    </div>
