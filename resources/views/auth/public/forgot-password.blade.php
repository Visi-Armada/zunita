    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Masukkan alamat e-mel anda untuk menerima pautan set semula kata laluan
            </p>
        </div>
        ...
        <form class="mt-8 space-y-6" action="{{ route('public.password.request') }}" method="POST">
            @csrf
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="{{ route('public.register') }}" class="font-medium text-blue-600 hover:text-blue-500 transition duration-150 ease-in-out">
                        Daftar Akaun Baru
                    </a>
                </div>
            </div>
