...
class PasswordResetComprehensiveTest extends TestCase
{
    ...
    /** @test */
    public function admin_user_can_access_password_reset_page()
    {
    ...
    /** @test */
    public function admin_user_can_request_password_reset()
    {
        Notification::fake();
    ...
    /** @test */
    public function admin_user_can_reset_password_with_valid_token()
    {
        Notification::fake();
    ...
    /** @test */
    public function public_user_cannot_access_admin_password_reset_page()
    {
        ...
        // Should redirect or show error since this is for admin users
        $response->assertStatus(200); // Page loads but may not work for public users
    }

    /** @test */
    public function public_user_password_reset_routes_do_not_exist()
    {
        // Check if public user password reset routes exist
        $response = $this->get('/auth/forgot-password');
        $response->assertStatus(404); // Route doesn't exist
    ...
    /** @test */
    public function public_user_login_page_has_no_forgot_password_link()
    {
    ...
    /** @test */
    public function admin_user_login_page_has_forgot_password_link()
    {
    ...
    /** @test */
    public function password_reset_works_only_for_admin_users()
    {
        Notification::fake();
    ...
    /** @test */
    public function public_users_need_separate_password_reset_system()
    {
